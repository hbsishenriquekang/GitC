...
namespace Locacao.Controllers
{
    public class AutomovelModeloesController : ApiController
    {
        ...
        [Route("Api/AutomovelModeloes/{codigo}/GetTermoByCodigo")]
        [HttpGet]
        public IEnumerable<AutomovelModelo> GetTermoByTipo(int codigo)
        {

            return db.AutomovelModelos.Where(x => x.CodigoFK == codigo);
